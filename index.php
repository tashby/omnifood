...
<head>
    ...
    <meta name="description" content="Omnifood premium food delivery service">
...
<body>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    <div>
                        ...
                        <p class="plan-price-meal">That's $13.30 per meal</p>
                    </div>
                    <div>
                        <ul>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal every 10 days</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i>Access to newest creations</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i>Free delivery</li>
                        </ul>
    ...
    <script src="https://cdn.jsdelivr.net/g/respond@1.4.2,selectivizr@1.0.3b"></script>
